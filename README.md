...
| Achievement | Detail |
|---|---|
| 🥇 **Hack Celestia Hackathon** | Top 10 — *SentinalGuard* |
| 🏆 **Smart India Hackathon** | Top 50, Internal Selection |
| 🎯 **Idea Carnival** | Rank 27 of 300 teams |
| 🔐 **Tata (via Forage)** | Cybersecurity Analyst — Job Simulation |
| 🤖 **HP LIFE Foundation** | AI for Beginners; Data Science & Analytics |
| 💡 **ID8Nxt × Microsoft MVP** | Ideathon 2.0 |
